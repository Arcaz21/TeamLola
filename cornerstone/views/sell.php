        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                	...
                	<br><br>
                    <li>
                        <a href="admin.php?name=<?php echo $_REQUEST['name']?>" ><i class="fa fa-cutlery"></i>Products <span class="badge"> Admin</span></a>
                    </li>
                    ...
                    <li>
                        <a href=""><i class="fa fa-pie-chart"></i>Sales <span class="badge"> Admin</span></a>
                    </li>

                    <li class="active-link">
                    <li>
                        <a href="sell.php?name=<?php echo $_REQUEST['name']?>"><i class="fa fa-shopping-cart "></i>Sell</a>
                    </li>
...
<a class="btn btn-primary" href="addproduct.php" target="iframe" style="padding-left: 20px; font-size: 30px">Add Products</a> -->
    ...
    <center>
        <br>          
        <iframe src="sales.php" name="iframe" width="1000" height="1000" frameborder="0" style="overflow: hidden;;"></iframe>           
    </center>
    </div>
    ...
    <div class="footer">
            ...
            <div class="row">
                <div class="col-lg-12" >
                    <center>&copy;  Team Pinky 2017</center>
                </div>
            </div>
        </div>
