        ...
        <div id="wrapper">
            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a style="cursor: pointer;" class="tablinks" onclick="options(event, 'Profile')" id="defaultOpen">
            ...
            <div id="page-wrapper">
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page-head-line">To Edit para sa guardian</h1>
                            <h1 class="page-subhead-line">
                              
                            </h1>
                            <div id="Profile" class="tabcontent">
                                <h3>profile sa students here mga infoo</h3>
                            </div>
                            
                            <div id="Billing" class="tabcontent">
                                <h3>Billing sa students here</h3>
