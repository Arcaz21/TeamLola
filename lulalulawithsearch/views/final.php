...
<center>
                        ...
                        <div class="panel panel-warning">
                            <div class="panel-heading">
                                <center><i class="fa fa-child fa-fw"></i><h3>Are you sure you want to submit this?</h3></center>
                            </div>

                            <div class="panel-body">
                                <div class="alert alert-info">
                                     <h5>Note: You cannot edit this anymore after your submission. Please check it one more time.</h5>       
                                </div>
...
<center>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <input type="hidden" name="levelID" value="<?php echo $value['levelID'] ?> ">
     ...
     <tr><input class="btn btn-info" value="SUBMIT FINAL" type="submit" name="submit"></tr>
    </form>
    <br>
