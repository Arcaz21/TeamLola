...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
    ...
    <?php error_reporting(E_ERROR | E_PARSE); foreach ($getbal as $index => $value): ?>
    ...
    <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>  
                                            ...
                                            <td>
                                                <?php echo $value['Acc_num']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['LRN']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['misc_Balance']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['tuition_Balance']; ?>
                                            </td>
                                            <td>
                                                <?php echo $value['entrance_Balance']; ?>
                                            </td>
                                            <td>
