        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page-head-line">To Edit para sa registrar</h1>
                            <h1 class="page-subhead-line">
                              
                            </h1>
                            <div id="Students" class="tabcontent">
                                <h3>Students table and stuffs over here</h3>
                            </div>
                            
                            
                            <div id="Addnew" class="tabcontent">
                                <h3>addnew students promt and etc, tapos naay check table blabla</h3>
                            </div>
