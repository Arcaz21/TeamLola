...
<a type="button" class="btn btn-info btn-lg" href="adduser.php" data-toggle="modal" data-target="#theModal">ADD USER</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a type="button" style="cursor: pointer;" class="btn btn-danger " <?php  $usern=$value['id']; ?> href="deleteuser.php?value=<?php echo $usern ?>" data-toggle="modal" data-target="#theModal"  >Delete</a>
                                            </td>
                                            <td style="text-align: center;">
                                                <center>
