                                    ...
                                    <tbody>
                                        ...
                                        <tr>  
                                            ...
                                            <td style="text-align: center;">
                                                <a type="button" style="cursor: pointer;" class="btn btn-danger " <?php  $lr=$value['LRN']; ?> href="deletestudent.php?value=<?php echo $lr ?>" data-toggle="modal" data-target="#theModal"  >Delete</a>
                                            </td>
                                            <td style="text-align: center;">
                                                <center>
                                                    <a type="button" style="cursor: pointer;" class="btn btn-warning " <?php  $lr=$value['LRN']; ?> href="editstudinfo.php?value=<?php echo $lr ?>" data-toggle="modal" data-target="#theModal"  >Edit</a>
                                                    </center>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
